      ...
      <div className="editorial-width">
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
            ...
            <h2 className="font-body text-4xl md:text-5xl font-bold text-foreground mb-16 text-center">
            ...
            {reasons.map((reason, i) => (
              <ScrollReveal key={i} delay={i * 0.12}>
                <div className="flex items-start gap-6 p-6 md:p-8 bg-card/50 border border-border/20 hover:border-primary/20 transition-colors duration-500">
                  <span className="font-body text-3xl text-primary/30 font-bold leading-none mt-1">
